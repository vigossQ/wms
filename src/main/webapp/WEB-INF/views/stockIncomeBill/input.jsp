                            ...
                            <c:if test="${stockIncomeBill.id!=null}">
                                <c:forEach items="${stockIncomeBill.items}" var="item">
                                    <tr>
                                        ...
                                        <td><input tag="costPrice" name="stockIncomeBill.items.costPrice"
                                                   class="ui_input_txt00" value="${item.costPrice}"/></td>
                                        <td><input tag="number" name="stockIncomeBill.items.number"
                                                   class="ui_input_txt00" value="${item.number}"/></td>
                                        <td><span tag="amount">${item.amount}</span></td>
                                        <td><input tag="remark" name="stockIncomeBill.items.remark"
